	...
	public class RegistrarClienteController {
	    ...
	    private void agregarRegistroAction() throws Exception {
	    	...
	    	if(datosValidos(nombre, correo, telefono, nombreMascota, edadMascota, sexoMascota)==true){
				...
				try {
					...
					mostrarMensaje("Notificación Registro", "cliente ya existe", "el cliente con nombre "+nombre+" ya se encuentra registrado", AlertType.ERROR);
	    ...
	    void EliminarRegistro(ActionEvent event) {
			...
			if(clienteSeleccionado == null){
				...
				boolean eliminado = main.eliminarRegistro(clienteSeleccionado.getNombre());
				if(eliminado){
					listaRegistroData.remove(clienteSeleccionado);
